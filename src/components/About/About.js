    ...
    <section className="about">
      <Container>
        ...
        <Row className="align-items-center">
          ...
          <Col xl={6} md={8}>
            <h3>We Provide Best Xiaomi Smartphones In The World</h3>
            <p>
              To get creative on the go with the best smartphones you can buy in
            ...
            <div className="icons-container ">
              <div className="icons">
                ...
                <span>cost free delivery</span>
              </div>
              <div className="icons">
                <i className="fas fa-dollar-sign"></i>
                <span>easy payments process</span>
              </div>
              <div className="icons">
                <i className="fas fa-headset"></i>
                <span>24/7 services</span>
              </div>
              <button className="btn-style">Learn More us</button>
            </div>
          </Col>
        </Row>
      </Container>
